...
def max_treasure_DFS_stack(treasures_, options_):
    """
...
def max_treasure_DFS_recursive(treasures_, options_):
    """
    Recursive DFS with a single shared path.

    This one never had the path-copy problem:
    push -> recurse -> pop.
    """
    best_leaf = None
...
def max_treasure_BFS_queue(treasures_, options_):
    """
    Iterative BFS using deque.

    queue stores indices into pool rather than full states.
    """
    pool = [
        (0, treasures_[0], -1, 0)
    ]
...
def max_treasure_BFS_recursive(treasures_, options_):
    """
...
def solve():
    ...
    visited_sequence, jump_sequence, total = max_treasure_DFS_stack(treasures_, options_)
    print_res(treasures_, visited_sequence, jump_sequence, total)
    print("========================================================")
    visited_sequence, jump_sequence, total = max_treasure_DFS_recursive(treasures_, options_)
    print_res(treasures_, visited_sequence, jump_sequence, total)
    print("========================================================")
    visited_sequence, jump_sequence, total = max_treasure_BFS_queue(treasures_, options_)
    print_res(treasures_, visited_sequence, jump_sequence, total)
    print("========================================================")
    visited_sequence, jump_sequence, total = max_treasure_BFS_recursive(treasures_, options_)
    print_res(treasures_, visited_sequence, jump_sequence, total)
